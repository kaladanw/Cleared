...
> Once you've absorbed it, archive it: `git mv mds/handoff.md
...
- **Web-port plan** — another (remote) Claude instance pushed
  ...
  (`mds/phase-web.md`) for a browser-extension web version. Its key finding:
  ...
  decide later whether to adopt it. Non-destructive, isolated to `mds/`.
